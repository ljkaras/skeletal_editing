...
# Description: Extracts SMILES codes from a CSV file.
# Parameters:
#   - file_path: Path to the CSV file containing SMILES codes.
# Returns:
#   - A list of SMILES strings extracted from the CSV file.
...
# Description: Loads a file and returns its contents as a list of strings.
# Parameters:
...
# Description: Computes Morgan fingerprints for a list of SMILES strings.
# Parameters:
#   - smiles_list: List of SMILES strings.
#   - radius: Radius for the Morgan fingerprint (default is 2).
#   - n_bits: Size of the fingerprint vector (default is 2048 bits).
# Returns:
#   - A list of Morgan fingerprints corresponding to the SMILES strings.
...
# Function to plot KDE contours, using consistent axes
