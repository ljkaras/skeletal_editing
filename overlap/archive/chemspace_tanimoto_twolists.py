...
# Function to plot combined results for two datasets
def plot_combined_results(reduction_result, title, labels):
...
def smiles_to_combined_reduction(smiles_list1, smiles_list2):
    ...
    plot_combined_results(pca_result, 'PCA of Combined SMILES Lists based on Tanimoto Similarity', labels)
    
    # Step 6: Apply UMAP
    umap_result = apply_umap(similarity_matrix)
    plot_combined_results(umap_result, 'UMAP of Combined SMILES Lists based on Tanimoto Similarity', labels)
