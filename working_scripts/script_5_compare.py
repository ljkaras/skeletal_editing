...
def compare_files(original_file, compare_file):
    ...
    common_molecules_path = os.path.join(comparisons_path, f"common_molecules_{original_file_name}.csv")
    new_molecules_path = os.path.join(comparisons_path, f"new_molecules_{original_file_name}.csv")
...
if __name__ == '__main__':
    ...
    comparisons_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'comparisons')
