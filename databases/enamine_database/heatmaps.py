...
results_filepath = '../enamine_database/results.txt' # change this for each database directory
results_lines = load_file_as_list(results_filepath)

symmetric_filepath = '../enamine_database/symmetric_molecules.txt' # change this for each database directory
...
percent_new_df = pd.DataFrame(percent_new_arr,
                              index = frameworks,
                              columns = frameworks)
GenerateHeatmap(percent_new_df, 'Percentage of Unique Compounds that are New (Enamine)', filename = 'percent_new_count.png')
...
percent_common_df = pd.DataFrame(percent_common_arr,
                              index = frameworks,
                              columns = frameworks)
GenerateHeatmap(percent_common_df, 'Percentage of Unique Compounds that are Know (Enamine)', filename = 'percent_common_count.png')
