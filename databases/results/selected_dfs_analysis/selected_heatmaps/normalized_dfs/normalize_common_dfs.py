...
for database in database_list:
    ...
    raw_data_df = pd.read_csv(f'../unnormalized_select_dfs/percent_common_df_{database}_select.csv', index_col=0)
    ...
    normalized_common_df.to_csv(f'normalized_common_df_{database}.csv', index=True)
