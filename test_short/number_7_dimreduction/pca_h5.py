...
def main(dataframe, output_filename):
    ...
    # Reduce the fingerprint dimensionality using PCA
    pca = PCA(n_components=2)
    embedding = pca.fit_transform(list(dataframe['Fingerprint']))
    
    # Add the reduced dimensions to the dataframe
    dataframe['PCA_1'] = embedding[:, 0]
    dataframe['PCA_2'] = embedding[:, 1]
...
if __name__ == '__main__':
    ...
    umap_csv = os.path.join(script_dir, "pca_reduced_data.csv")
