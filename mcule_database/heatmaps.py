...
results_filepath = '../mcule_database/results.txt' # change this for each database directory
results_lines = load_file_as_list(results_filepath)

symmetric_filepath = '../mcule_database/symmetric_molecules.txt' # change this for each database directory
